...
export const botConfig = {
  ...
  // =========================
  verification: {
    defaultMessage: "Click the button below to verify and unlock the server.",
  ...
  messages: {
    ...
    errorOccurred: "Something went wrong while running this command.",
    missingPermissions: "I'm missing the required permissions to do that.",
...
export function getColor(path, fallback = "#94A3B8") {
